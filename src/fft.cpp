...
void ComputeFFT(int NumSamples,
...
void RealFFT(int NumSamples, float *RealIn, float *RealOut, float *ImagOut)
{
   ...
   ComputeFFT(Half, 0, tmpReal, tmpImag, RealOut, ImagOut);
...
void FFT::inversePowerSpectrum(int start, int half, int windowSize, float *finalOut,float *magnitude,float *phase) {
   ...
   float *out_img = new float[windowSize];
    ...
    ComputeFFT(windowSize, 1, in_real, in_img, out_real, out_img); // second parameter indicates inverse transform
